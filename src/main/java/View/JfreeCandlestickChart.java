...
public class JfreeCandlestickChart extends JPanel {
    ...
    public void showCandles(StockCandles candles) {
        ohlcSeries.clear();
        volumeSeries.clear();
    ...
    public void addCandle(Candle candle) {
        //long millisecond = TimeUtils.msFromMidnight(candle.dateTime);
        FixedMillisecond t = new FixedMillisecond(candle.dateTime.toEpochSecond() * 1000);
        ohlcSeries.add(t, candle.open, candle.high, candle.low, candle.close);
        volumeSeries.add(t,candle.volume);
    }
